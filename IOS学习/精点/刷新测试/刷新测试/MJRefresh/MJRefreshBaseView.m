...
-(GMActivityView *)indicatorView{
    if (_indicatorView == nil) {
        GMActivityView * indicatorView = [[GMActivityView alloc]initWithFrame:CGRectMake(20, 20, 25, 25)];
...
- (void)layoutSubviews
{
    ...
    // 2.指示器
    CGFloat arrowX = self.mj_width * 0.5 - 90;
    
    self.indicatorView.center = CGPointMake(arrowX, self.mj_height * 0.5);;
}
